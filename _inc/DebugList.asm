...
; Extension by Mildanner (ft. RetroKoH)
; ---------------------------------------------------------------------------
DebugList:
	dc.w .GHZ-DebugList
	dc.w .LZ-DebugList
...
;		mappings	object		subtype	frame	VRAM setting
	...
	dbug	Map_Spike,	id_Spikes,	1,	0,	make_art_tile(ArtTile_Spikes,0,0)
	dbug	Map_Plat_GHZ,	id_BasicPlatform,	0,		0,		make_art_tile(ArtTile_Level,2,0)	; Basic Plat
	dbug	Map_Plat_GHZ,	id_BasicPlatform,	3,		0,		make_art_tile(ArtTile_Level,2,0)	; Falling Plat
	dbug	Map_Plat_GHZ,	id_BasicPlatform,	1,		0,		make_art_tile(ArtTile_Level,2,0)	; Plat Move (Horizontal)
	dbug	Map_Plat_GHZ,	id_BasicPlatform,	2,		0,		make_art_tile(ArtTile_Level,2,0)	; Plat Move (Vertical)
	dbug	Map_Plat_GHZ,	id_BasicPlatform,	$A,		1,		make_art_tile(ArtTile_Level,2,0)	; Moving downside plat
	dbug	Map_Bri_internal,	id_Bridge, 8,	0,	make_art_tile(ArtTile_GHZ_Bridge,2,0)
	dbug	Map_Bri_internal,	id_Scenery, $3,	1,	make_art_tile(ArtTile_GHZ_Bridge,2,0)
	dbug	Map_Hel,	id_Helix, $3,	1,	make_art_tile(ArtTile_GHZ_Spike_Pole,2,0)
	...
	dbug	Map_Smash,	id_SmashWall,	0,		0,		make_art_tile(ArtTile_GHZ_SLZ_Smashable_Wall,2,0)	; Smashable Wall (Left side)
	dbug	Map_Smash,	id_SmashWall,	1,		1,		make_art_tile(ArtTile_GHZ_SLZ_Smashable_Wall,2,0)	; Smashable Wall (Middle)
	dbug	Map_Smash,	id_SmashWall,	2,		2,		make_art_tile(ArtTile_GHZ_SLZ_Smashable_Wall,2,0)	; Smashable Wall (Right side)
	dbug	Map_Ledge,	id_CollapseLedge,	0,		0,		make_art_tile(ArtTile_Level,2,0)		; Collapsing Ledge
	dbug	Map_Ledge,	id_CollapseLedge,	1,		1,		make_art_tile(ArtTile_Level,2,0)		; Collapsing Ledge
