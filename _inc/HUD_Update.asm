...
Hud_Base:
		...
		lea	Hud_TilesCenti(pc),a2		; load tile information array
		moveq	#3-1,d2				; do 3 characters (minus 1 for loop)
		bsr.s	loc_1C83E			; write to VRAM, then return for the remaining HUD
		endif
